...
const CountriesPage = () => {
    ...
    useEffect(() => {
        if (selectedCountry) {
            axios.get(`http://127.0.0.1:5000/countries/${selectedCountry}/cities`)
                .then((response) => {
    ...
    useEffect(() => {
        if (selectedCountry) {
            axios.get(`http://127.0.0.1:5000/countries/${selectedCountry}/years`)
                .then((response) => {
    ...
    useEffect(() => {
        if (selectedCountry) {
            setIsLoading(true);
            axios.get(`http://127.0.0.1:5000/countries/${selectedCountry}/${selectedYear}/${selectedCities}`)
                .then((response) => {
