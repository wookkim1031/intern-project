...
const Product = () => {
    ...
    useEffect(() => {
        axios.get(`https://intern-project-c87y5550q-johan-kims-projects.vercel.app/products`)
            .then((response) => {
    ...
    useEffect(() => {
        if(product !== "all") {
            axios.get(`https://intern-project-c87y5550q-johan-kims-projects.vercel.app/products/${product}/${country}/${city}`)
            .then((response) => {
