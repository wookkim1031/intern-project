...
const Product = () => {
    ...
    useEffect(() => {
        axios.get(`intern-project-liart.vercel.app/products`)
            .then((response) => {
    ...
    useEffect(() => {
        if(product !== "all") {
            axios.get(`intern-project-liart.vercel.app/${product}/${country}/${city}`)
            .then((response) => {
    ...
    useEffect(() => {
        if(product !== "all" && country !== "all") {
            axios.get(`intern-project-liart.vercel.app/products/${product}/${country}/${city}`)
                .then((response) => {
